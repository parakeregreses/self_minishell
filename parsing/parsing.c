...
/*   Updated: 2025/06/08 13:10:33 by jlaine-b         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	**select_quoted_str(char *str)
{
	char	**tab1;
	char	**tab2;
	int		n;
	...
	n = tab_size(tab1);
	while (ft_charinstr(tab1[n - 1], '\'') == TRUE || ft_charinstr(tab1[n - 1], '\"') == TRUE)
	{
		tab2 = select_quoted_str(tab1[n - 1]);
